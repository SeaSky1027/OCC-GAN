...
class HiFiGanWrapper:
    def __init__(self, ckpt_path: str, device: str = 'cuda:0'):
        ...
        self.generator_pretrain_path: str = os.path.join(ckpt_path, 'hifigan_checkpoint')
        self.config_path: str = os.path.join(ckpt_path, 'hifigan_config.json')
        self.load_hifi_gan()
    ...
    def load_hifi_gan(self):
        ...
        self.generator = Generator(AttrDict(json_config))

        state_dict_g = torch.load(self.generator_pretrain_path, map_location='cpu')
    ...
    def generate_audio(self, input_feature):
        final_shape_len = 3
        ...
        with torch.no_grad():
            ...
            audio = self.generator(input_feature)
            audio = audio.squeeze()
...
if __name__ == '__main__':
    ...
    hifi_gan = HiFiGanWrapper(
        './pretrained_checkpoints'
    )
    logging.info(count_parameters(hifi_gan.generator))