...
class CLAP(nn.Module):
    def __init__(
        ...
        if audio_cfg.model_type == "PANN":
            ...
            print(f"Model config for {audio_cfg.model_type} not found")
        ...
        if text_cfg.model_type == "transformer":
            ...
            print(f"Model config for {text_cfg.model_type} not found")
    ...
    def encode_text(self, text, device):
        if self.text_branch_type == "transformer":
            ...
            print(f"Model type {self.text_branch_type} not found")
