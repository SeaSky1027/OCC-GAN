...
def create_model(
    ...
    if pretrained == "openai":
        if amodel_name in _MODEL_CONFIGS:
            print(f"Loading {amodel_name} model config.")
        ...
        print(f"Loading pretrained ViT-B-16 text encoder from OpenAI.")
        ...
        if pretrained:
            ...
            if checkpoint_path:
                print(f"Loading pretrained {amodel_name}-{tmodel_name} weights ({pretrained}).")
        ...
        if pretrained_audio:
            ...
            print(f"Loading pretrained {amodel_name} weights ({pretrained_audio}).")
            param_names = [n for n, p in model.named_parameters()]
            for n in param_names:
