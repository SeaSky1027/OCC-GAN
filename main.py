...
def main(args):
    ...
    score_dict = calculate_metric(args, generator, vocoder, evaluator, writer, 0, device)
    ...
    for epoch in range(args.epoch):
        ...
        if epoch % args.calc_metric_freq == 0:
            ...
            score_dict = calculate_metric(args, generator, vocoder, evaluator, writer, epoch, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--oneself_conditioned_contrastive_loss", action='store_true')
